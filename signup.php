...
if($user){
  ...
  <strong>Something went wrong!</strong> This user already exist.
...
?>
 <header>
    ...
    <div class="container"> 
    <h1>Create your <span>Acoount</span></h1>
  ...
  <button type="submit" class="btn btn-primary" style="font-weight: 600;" >Sign Up</button>
  <div class="create_singup" id="create_acc">
              Already have an account? <a href="login.php" id="signup" style="color: #ffa343">Sign Up</a>
            </div>
